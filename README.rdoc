...
according to the environment. For example for the development environment, name is .env.development.
Here's a list of environment variables that this app makes use for:
